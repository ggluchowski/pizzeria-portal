...
class Booking {
  ...
  render(element){
    ...
    thisBooking.dom.hourPickerKROPKA = document.querySelector(select.widgets.hourPicker.kropka);

    //#js-rangeSlider-6321359b-b874-d692-0d1f-e4c69941ad13 > div.rangeSlider__handle.rangeSlider__handle__horizontal
  ...
  initWidgets(){
    ...
    thisBooking.dom.hourPickerKROPKA.addEventListener('mouseup', function(e){
      console.log('MouseUP', e.type);
      thisBooking.clearTable();

    });

    // thisBooking.dom.hourPicker.addEventListener('click', function(e){
    //   thisBooking.clearTable();
    //   console.log(e.type);
    // });
    ...
    tablesContainer.addEventListener('mousedown', function(e){
